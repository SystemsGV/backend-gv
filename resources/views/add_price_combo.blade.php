...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">eCommerce /</span><span> Agregar Precio Combo</span>
        </h4>
            ...
            <form id="ecommercePriceAdd" enctype="multipart/form-data">
                ...
                <div
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <h4 class="mb-1 mt-3">Añadir un nuevo precio de combo</h4>
                    </div>
                    <div class="d-flex align-content-center flex-wrap gap-3">
                        <a href="{{ route('Productos') }}" class="btn btn-outline-secondary">Descartar</a>
                        <button type="submit" class="btn btn-primary" name="accion" value="publicar">Agregar Precio
                            Combo</button>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <!-- Category -->
                            <h6>1. Combo y Precio</h6>
                            <div class="row">
                                <div class="col-12 col-lg-8">
                                    <div class="form-floating form-floating-outline mb-4">
                                        <select id="product-org" name="combo" class="select2 form-select"
                                            data-placeholder="Seleccionar Combo">
                                            <option value="0">Selecionar Combo</option>
                                            @foreach ($combos as $combo)
                                                <option value="{{ $combo->id_combo }}" data-minDate="{{ $combo->combo_init_date }}" data-maxDate="{{ $combo->combo_finish_date }}">{{ $combo->name_combo }}</option>
                                            @endforeach
                                        </select>
                                        <label for="vendor">Combo</label>
                                    </div>
                                </div>
                            ...
                            <h6>2. Titulo Precio</h6>
                            <div class="row">
                                <div class="col-12 col-lg-12">
                                    <div class="form-floating form-floating-outline  mb-4">
                                        <textarea id="autosize-demo" rows="3" class="form-control" name="productTitle"></textarea>
                                    </div>
                                </div>
                            </div>
                            <h6>3. Dias y Horario</h6>
                                ...
                                <div class="col-md-3 mb-md-0 mb-10">
                                    <div class="form-check custom-option custom-option-icon">
                                        <label class="form-check-label custom-option-content" for="choice_dates">
                                            ...
                                            <input class="form-check-input" type="radio" value="1" id="choice_dates"
                                                name="choice_dates">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-md-0 mb-10">
                                    <div class="form-check custom-option custom-option-icon">
                                        <label class="form-check-label custom-option-content" for="choice_days">
                                            ...
                                            <input class="form-check-input" type="radio" value="2" id="choice_days"
                                                name="choice_dates">
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="collapse" id="collapse_days">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <!-- Subcategory -->
                                        <div class="form-floating form-floating-outline mb-4">
                                            <select id="shift-org-days" name="shift-org-days" class="select2 form-select"
                                                data-placeholder="Seleccionar Turno">
                                                <option value="0" disabled>Selecionar Turno</option>
                                                <option value="1">Turno Completo </option>
                                                <option value="2">Turno 2:00 pm a 6:00 pm</option>
                                            </select>
...
@section('scripts')
    ...
    <script src="{{ asset('js/app-ecommerce-price-combo-add.js') }}"></script>
@endsection
