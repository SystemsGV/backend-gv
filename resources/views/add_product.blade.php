        ...
        <div class="app-ecommerce">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                ...
                <div class="d-flex align-content-center flex-wrap gap-3">
                    <button class="btn btn-outline-secondary">Descartar</button>
                    <button class="btn btn-outline-primary">Guardar Borrado</button>
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="form-control p-0 pt-1">
                                    ...
                                    <div class="short-editor border-0 pb-1" id="ecommerce-category-description">
                                    </div>
                                </div>
                            </div>
                            <!-- Comment -->
                            <div>
                                ...
                                <div class="form-control p-0 pt-1">
                                    ...
                                    <div class="general-editor border-0 pb-1" id="ecommerce-category-description">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                ...
                                <img src="{{ asset('img/avatars/1.png') }}" alt="user-avatar"
                                    class="d-block h-px-200 rounded" id="uploadedAvatar">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                ...
                                <img src="{{ asset('img/avatars/1.png') }}" alt="user-avatar"
                                    class="d-block h-px-200 rounded" id="uploadedAvatar2">
                            </div>
                        </div>
                    </div>
                    <!-- /Media -->
                ...
                <div class="col-12 col-lg-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 col ecommerce-select2-dropdown">
                                <div class="form-floating form-floating-outline">
                                    <select id="subcategory-org" class="select2 form-select"
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Discounted Price -->
                            <div class="form-floating form-floating-outline mb-4">
                                <input type="number" class="form-control disabled" id="ecommerce-product-discount-price"
                                    placeholder="Discounted Price" name="productDiscountedPrice"
                                    aria-label="Product discounted price">
                                <label for="ecommerce-product-discount-price">Monto descontado</label>
                            </div>
                        </div>
                    </div>
                    <!-- /Pricing Card -->
